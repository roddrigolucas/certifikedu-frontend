  ...
  return (
    <AccordionPrimitive.Trigger
      className={cn(
        ...
        'hover:bg-slate-800/80 hover:text-white text-slate-200 transition-colors ease border-0',
        {
          'bg-slate-800/60 text-white hover:bg-slate-800/80': checkIsActive(
            menu.path,
            location.pathname,
            true,
          ),
      ...
      <div className="inline-flex gap-4">
        <menu.icon
          className={cn('size-5 min-w-5', {
            'text-emerald-500': checkIsActive(menu.path, location.pathname, true),
