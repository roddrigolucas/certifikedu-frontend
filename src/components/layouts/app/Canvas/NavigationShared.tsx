...
import { canvasMenuPaths } from '@/constants/navigation/menuPaths/canvas.paths';
                ...
                <div className="mt-2 flex w-full flex-col gap-2 ">
                  {menu.subMenu.map((subMenu) => (
                    <Link
                      ...
                      to={subMenu.path}
                      className={cn(
                        'justify-start px-8 pl-[3.15rem] py-2 rounded-md w-full font-normal text-white hover:bg-blue-zodiac-900/20 transition-colors ease',
                        {
